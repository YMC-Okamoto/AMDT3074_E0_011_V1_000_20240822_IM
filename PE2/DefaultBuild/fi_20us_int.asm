...
#@	compiled at Thu Aug 22 10:25:06 2024
	...
	.file "src\fi_20us_int.c"

	$reg_mode 32
	.dbl_size 8

	.public _u1_cnt_20us_int_inv1, 1
	.public _fi_20us_int
	.public _fb_20us_int_init

	.section .text, text
_fi_20us_int:
	.stack _fi_20us_int = 52
	.line "C:/Users/basa2/Documents/AMDT-NPC/AMDT3074_【伊丹】_テクニカルサポート様向け_SiCモジュール搭載水冷式汎用インバータ（AMDTINV_SH600A_SiC）/E_制御関係/IM/20240822_IM/PE2/src/fi_20us_int.c", 50
	...
	.line "C:/Users/basa2/Documents/AMDT-NPC/AMDT3074_【伊丹】_テクニカルサポート様向け_SiCモジュール搭載水冷式汎用インバータ（AMDTINV_SH600A_SiC）/E_制御関係/IM/20240822_IM/PE2/src/fi_20us_int.c", 56
	ei
	.line "C:/Users/basa2/Documents/AMDT-NPC/AMDT3074_【伊丹】_テクニカルサポート様向け_SiCモジュール搭載水冷式汎用インバータ（AMDTINV_SH600A_SiC）/E_制御関係/IM/20240822_IM/PE2/src/fi_20us_int.c", 62
	movhi HIGHW1(#_u1_cnt_20us_int_inv1), r0, r2
	ld.b LOWW(#_u1_cnt_20us_int_inv1)[r2], r5
	add 0x00000001, r5
	st.b r5, LOWW(#_u1_cnt_20us_int_inv1)[r2]
	.line "C:/Users/basa2/Documents/AMDT-NPC/AMDT3074_【伊丹】_テクニカルサポート様向け_SiCモジュール搭載水冷式汎用インバータ（AMDTINV_SH600A_SiC）/E_制御関係/IM/20240822_IM/PE2/src/fi_20us_int.c", 68
	di
	...
	eiret
_fb_20us_int_init:
	.stack _fb_20us_int_init = 0
	.line "C:/Users/basa2/Documents/AMDT-NPC/AMDT3074_【伊丹】_テクニカルサポート様向け_SiCモジュール搭載水冷式汎用インバータ（AMDTINV_SH600A_SiC）/E_制御関係/IM/20240822_IM/PE2/src/fi_20us_int.c", 82
	jmp [r31]
	.section .bss, bss
_u1_cnt_20us_int_inv1:
	.ds (1)
