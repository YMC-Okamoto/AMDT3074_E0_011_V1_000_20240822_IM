...
#@	compiled at Thu May 23 14:28:27 2024
	...
	.file "src\fi_1ms_inv1_seqctrl.c"

	$reg_mode 32
	.dbl_size 8

	.extern _u1_mode_inv1_main
	.public _fi_1ms_inv1_seqctrl
	.extern _fb_main_error_init
	.public _fb_1ms_inv1_seq_flaginit

	.section .text, text
_fi_1ms_inv1_seqctrl:
	.stack _fi_1ms_inv1_seqctrl = 4
	.line "C:/Users/ITAMI_NPC05/Documents/AMDT_NPC/AMDT3090_住友商事マシネックス（本田技術研究所）様向け_48V600A水冷ダブルインバータ開発/E_制御関係/AMDT3090_E0_001_V1_000_20240523/PE2/src/fi_1ms_inv1_seqctrl.c", 44
	prepare 0x00000001, 0x00000000
	.line "C:/Users/ITAMI_NPC05/Documents/AMDT_NPC/AMDT3090_住友商事マシネックス（本田技術研究所）様向け_48V600A水冷ダブルインバータ開発/E_制御関係/AMDT3090_E0_001_V1_000_20240523/PE2/src/fi_1ms_inv1_seqctrl.c", 47
	movhi HIGHW1(#_u1_mode_inv1_main), r0, r2
	ld.bu LOWW(#_u1_mode_inv1_main)[r2], r2
	cmp 0x00000000, r2
	bnz9 .BB.LABEL.1_2
.BB.LABEL.1_1:	; return
	.line "C:/Users/ITAMI_NPC05/Documents/AMDT_NPC/AMDT3090_住友商事マシネックス（本田技術研究所）様向け_48V600A水冷ダブルインバータ開発/E_制御関係/AMDT3090_E0_001_V1_000_20240523/PE2/src/fi_1ms_inv1_seqctrl.c", 58
	dispose 0x00000000, 0x00000001, [r31]
.BB.LABEL.1_2:	; if_then_bb
	.line "C:/Users/ITAMI_NPC05/Documents/AMDT_NPC/AMDT3090_住友商事マシネックス（本田技術研究所）様向け_48V600A水冷ダブルインバータ開発/E_制御関係/AMDT3090_E0_001_V1_000_20240523/PE2/src/fi_1ms_inv1_seqctrl.c", 51
	jarl _fb_main_error_init, r31
	.line "C:/Users/ITAMI_NPC05/Documents/AMDT_NPC/AMDT3090_住友商事マシネックス（本田技術研究所）様向け_48V600A水冷ダブルインバータ開発/E_制御関係/AMDT3090_E0_001_V1_000_20240523/PE2/src/fi_1ms_inv1_seqctrl.c", 52
	movhi HIGHW1(#_u1_mode_inv1_main), r0, r2
	st.b r0, LOWW(#_u1_mode_inv1_main)[r2]
	dispose 0x00000000, 0x00000001, [r31]
_fb_1ms_inv1_seq_flaginit:
	.stack _fb_1ms_inv1_seq_flaginit = 0
	.line "C:/Users/ITAMI_NPC05/Documents/AMDT_NPC/AMDT3090_住友商事マシネックス（本田技術研究所）様向け_48V600A水冷ダブルインバータ開発/E_制御関係/AMDT3090_E0_001_V1_000_20240523/PE2/src/fi_1ms_inv1_seqctrl.c", 74
	movhi HIGHW1(#_u1_mode_inv1_main), r0, r2
	st.b r0, LOWW(#_u1_mode_inv1_main)[r2]
	jmp [r31]
