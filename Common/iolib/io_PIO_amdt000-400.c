...
void pio_init ( void )
{
	...
	/*	P1_0 / TAUD1I0 / TAUD1O0 / TAUD1O1 / ENCA0TIN0 / TSG30O0 / TAPA2ESO	*/
		PORT.PCR1_0.UINT32		=	0x00010010;						/* 入力		*/
	...
	/*	P1_14 / TAUD1I14 / TAUD1O14 / TAUD1O15 / TSG31O0 / TAPA3ESO	*/
		PORT.PCR1_14.UINT32		=	0x00010010;						/* 入力		*/
	...
	/*	P2_2 / TAUD0I10 / TAUD0O10 / TAPA0UP / INTP2					*/
		PORT.PCR2_2.UINT32		=	0x00010010;						/* 入力		*/
	/*	P2_3 / TAUD0I11 / TAUD0O11 / TAPA0UN / INTP3					*/
		PORT.PCR2_3.UINT32		=	0x00010010;						/* 入力		*/
	/*	P2_4 / TAUD0I12 / TAUD0O12 / TAPA0VP / INTP4					*/
		PORT.PCR2_4.UINT32		=	0x00010010;						/* 入力		*/
	...
	/*	 P2_7 / TAUD0I15 / TAUD0O15 / TAPA0WN / INTP7					*/
		PORT.PCR2_7.UINT32		=	0x00010010;						/* 入力		*/
	/*-------------------------------------------------------------------------------*/
	/*---- P3グループ ----*/
	/*	P3_0 / TAUD0I5 / TAUD0O5									*/
		PORT.PCR3_0.UINT32		=	0x00010010;						/* 入力		*/
	/*	P3_1 / TAUD0I7 / TAUD0O7 / ADCC0TRG							*/
		PORT.PCR3_1.UINT32		=	0x00010010;						/* 入力		*/
	/*	P3_2 / TAUD1I5 / TAUD1O5 / ADCC1TRG							*/
		PORT.PCR3_2.UINT32		=	0x00010010;						/* 入力		*/
	/*	P3_3 / TAUD1I7 / TAUD1O7 / TAPA2ESO							*/
		PORT.PCR3_3.UINT32		=	0x00010010;						/* 入力		*/
	/*	P3_4 / ADCC1TRG	 / TAPA3ESO									*/
		PORT.PCR3_4.UINT32		=	0x00010010;						/* 入力		*/
	/*	P3_5 / TAPA0ESO												*/
		PORT.PCR3_5.UINT32		=	0x00010010;						/* 入力		*/
	/*	P3_6 / TAPA1ESO												*/
		PORT.PCR3_6.UINT32		=	0x00010010;						/* 入力		*/
	/*	P3_7														*/
		PORT.PCR3_7.UINT32		=	0x00010010;						/* 入力		*/
	/*-------------------------------------------------------------------------------*/
	/*---- P4グループ ----*/
	/*	P4_0 / CSIH1SI												*/
	...
	/*	P4_8 / CSIH0SO / CSIH1RYI / CSIH1RYO						*/
		PORT.PCR4_8.UINT32		=	0x00010010;						/* 入力		*/
	/*	P4_9 / CSIH0SC												*/
		PORT.PCR4_9.UINT32		=	0x00010010;						/* 入力		*/
	/*	P4_10 / TPBA0O / CSIH0CSS0									*/
		PORT.PCR4_10.UINT32		=	0x00010010;						/* 入力		*/
	...
	/*	P5_1 / RLIN22TX / SCI0TXD									*/
		PORT.PCR5_1.UINT32		=	0x00010010;						/* 入力		*/
	/*	P5_2 / RLIN21RX / SCI0SCK									*/
		PORT.PCR5_2.UINT32		=	0x00010010;						/* 入力		*/
...
//		PORT.PCR5_5.UINT32		=	0x00010010;						/* 入力		*/
	...
	/*	P5_6 / TPBA1O / TAPA0ESO									*/
		PORT.PCR5_6.UINT32		=	0x00010010;						/* 入力		*/
	/*	P5_7 / SCI2SCK												*/
		PORT.PCR5_7.UINT32		=	0x00010010;						/* 入力		*/
	/*	P5_8 / SCI2RXD												*/
		PORT.PCR5_8.UINT32		=	0x00010010;						/* 入力		*/
	/*	P5_9 / SCI2TXD												*/
		PORT.PCR5_9.UINT32		=	0x00010010;						/* 入力		*/
	/*-------------------------------------------------------------------------------*/
	/*---- P6グループ ----*/
	/*	P6_0 														*/
	...
	/*	P6_3 														*/
		PORT.PCR6_3.UINT32		=	0x00010010;						/* 入力		*/
	/*	P6_4 / TAPA0ESO												*/
		PORT.PCR6_4.UINT32		=	0x00000000;						/* 出力		*/
	/*	P6_5 / TAPA1ESO												*/
		PORT.PCR6_5.UINT32		=	0x00000000;						/* 出力		*/
	/*	P6_6 / TAUD1I5 / TAUD1O5 / ADCC1TRG 						*/
		PORT.PCR6_6.UINT32		=	0x00000000;						/* 出力		*/
